...
EPSILON = lambda t: 0 # 0.1 / (t+1)**0.1 # <--------------------- CHANGE BACK!!!!!!!!

def get_alg_dict(baseline_policy):
    alg_dict = {
        "Baseline" : lambda x, *args, **kwargs: (baseline_policy(x), 1, {}),
        ...
        "Unsafe oracle" : utils.wrapped_partial(
            bandit_learning.alg_unsafe_oracle,
            baseline_policy=baseline_policy
        ),
