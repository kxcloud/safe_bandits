...
bandit_constructor = utils.wrapped_partial(
    BanditEnv.get_contextual_bandit_by_correlation, num_actions=5, correlation=correlation
)
...
evaluator = utils.wrapped_partial(
    ...
    experiment_name=f"Contextual bandit (Reward-safety corr={correlation})",
